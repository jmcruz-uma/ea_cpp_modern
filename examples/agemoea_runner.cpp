/// @file agemoea_runner.cpp
/// @brief AGE-MOEA benchmark runner — ea_cpp_modern vs jMetal.
///
/// Corre AGE-MOEA sobre ZDT1-ZDT4, NUM_RUNS veces por problema.
/// Salida CSV por stdout: system,problem,run,time_ms,igd
///
/// Compilar (benchmark):
///   g++-14 -std=c++23 -O3 -march=native -DNDEBUG -I include examples/agemoea_runner.cpp -o build/agemoea_runner -lm
///
/// Uso:
///   ./build/agemoea_runner [NUM_RUNS [BASE_SEED]]
...
// ── Parámetros (deben coincidir con JMetalAGEMOEABenchmark.java) ─────────────
...
// ── Un run de AGE-MOEA — devuelve {time_ms, igd} ─────────────────────────────
...
int main(int argc, char* argv[]) {
    ...
    std::cerr << "=== ea-cpp AGE-MOEA Benchmark ===\n";
