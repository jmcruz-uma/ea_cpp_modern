...
\begin{table}[h]
\centering
\caption{Energy consumption estimation}
\label{tab:energy}
\begin{tabular}{@{}lrrr@{}}
\toprule
\textbf{Framework} \u0026 \textbf{Time} \u0026 \textbf{Energy} \u0026 \textbf{Savings} \\
\midrule
ea-cpp \u0026 153 ms \u0026 5.5 J \u0026 \textbf{12$\times$} \\
jMetal \u0026 1831 ms \u0026 65.9 J \u0026 --- \\
\bottomrule
\end{tabular}
\end{table}

\textit{Note:} Estimates only. RAPL-capable hardware required for precise measurements.
...
\textbf{Future work}: GPU acceleration via SYCL, distributed island models, energy consumption benchmarking with RAPL-capable hardware.
