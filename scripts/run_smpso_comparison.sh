#!/usr/bin/env bash
# =============================================================================
# run_smpso_comparison.sh
# Comparativa multiobjetivo: ea_cpp_modern (SMPSO, C++) vs jMetal 7.4 (Java)
# Problemas: ZDT1, ZDT2, ZDT3, ZDT4
#
# Uso:
#   ./scripts/run_smpso_comparison.sh [OUTDIR] [NUMRUNS]
#
# Argumentos opcionales:
#   OUTDIR    directorio de salida    (default: results/smpso_comparison)
...
#   SKIP_JAVA=1 ./scripts/run_smpso_comparison.sh /tmp/smpso_test 1
#
# Ejemplo paper (30 runs):
#   ./scripts/run_smpso_comparison.sh results/smpso_paper 30
# =============================================================================
...
OUTDIR="${1:-${MODERN_ROOT}/results/smpso_comparison}"
NUMRUNS="${2:-30}"

CPP_BIN="${MODERN_ROOT}/build/smpso_runner"
...
build_java_benchmark() {
    echo "[3/4] Compilando JMetalSMPSOBenchmark.java..."
    ...
    javac -cp "${JMETAL_CP}" "${BENCH_DIR}/JMetalSMPSOBenchmark.java" -d "${OUTDIR}"
    echo "      → ${OUTDIR}/JMetalSMPSOBenchmark.class"
}
...
echo "============================================================"
echo " Algoritmo : SMPSO"
echo " Problemas : ZDT1 (d=30), ZDT2 (d=30), ZDT3 (d=30), ZDT4 (d=10)"
echo " Config    : swarm=100, max_evals=25000, archive=100"
echo "             PM pm=1/D eta_m=20 | w=0.1 | changeVel=-1"
echo " Runs      : ${NUMRUNS}"
echo " Salida    : ${OUTDIR}"
echo "============================================================"
echo ""
...
{
    echo "# Entorno de benchmark SMPSO"
    echo ""
    echo "## Fecha"
