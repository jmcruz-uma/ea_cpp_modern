...
/**
 * jMetal 7.4 GDE3 benchmark runner — ZDT1-ZDT4.
 * Usa GDE3Builder (jmetal-algorithm) con DE/rand/1/bin, CR=0.5, F=0.5.
 * result() devuelve el frente no dominado de la población final.
 *
 * Parámetros (deben coincidir con gde3_runner.cpp):
 *   Population : 100
 *   Max evals  : 25000
 *   CR         : 0.5
 *   F          : 0.5
 ...
 *
 * Uso:
 *   javac -cp <jmetal-jars> JMetalGDE3Benchmark.java
 *   java  -server -Xms512m -Xmx2g -XX:+UseG1GC -XX:+AlwaysPreTouch \
 *         -XX:+DisableExplicitGC -Djava.awt.headless=true \
 *         -cp <jmetal-jars>:. JMetalGDE3Benchmark results_jmetal.csv [NUM_RUNS [BASE_SEED]]
 */
public class JMetalGDE3Benchmark {

    static final int    POP_SIZE  = 100;
    static final int    MAX_EVALS = 25000;
    static final double CR        = 0.5;
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.err.println("=== jMetal 7.4 GDE3 Benchmark ===");
        System.err.printf("pop=%d  max_evals=%d  CR=%.1f  F=%.1f  variant=RAND_1_BIN  runs=%d  seed=%d%n",
                          POP_SIZE, MAX_EVALS, CR, F, numRuns, baseSeed);
