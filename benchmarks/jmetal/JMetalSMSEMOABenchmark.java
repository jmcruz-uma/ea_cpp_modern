 ...
 *
 * Uso:
 *   javac -cp <jmetal-jars> JMetalSMSEMOABenchmark.java
 *   java  -server -Xms512m -Xmx2g -XX:+UseG1GC -XX:+AlwaysPreTouch \
 *         -XX:+DisableExplicitGC -Djava.awt.headless=true \
 *         -cp <jmetal-jars>:. JMetalSMSEMOABenchmark results_jmetal.csv [NUM_RUNS [BASE_SEED]]
 */
public class JMetalSMSEMOABenchmark {
