...
constexpr std::string_view encoding_name(Encoding enc) {
    switch (enc) {
        case Encoding::Real:        return "Real";
        case Encoding::Binary:      return "Binary";
        case Encoding::Permutation: return "Permutation";
        case Encoding::Integer:     return "Integer";
        case Encoding::Composite:   return "Composite";
    }
    return "Unknown";
}
